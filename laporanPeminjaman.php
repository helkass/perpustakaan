...
$aksi = "";
    ...
    if($op == 'delete'){
        ...
        // arahkan ke sanksi.php

        // true? execute code below
            $id_pinjam = $_GET['id_pinjam'];
            $sql1 = "DELETE FROM tb_peminjaman WHERE id_pinjam = '$id_pinjam'";
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            ...
                                            <tbody>
                                                <?php
                                                $sql2 = "SELECT * FROM tb_peminjaman ORDER BY id_pinjam DESC";
                                                ...
                                                while($r2 = mysqli_fetch_array($q2)){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td scope="row"><?=$tanggal_pinjam?></td>
                                                        <td scope="row"><?=$tanggal_pengembalian?></td>
                                                        <td scope="row">
                                                            <a href="laporanPeminjaman.php?op=delete&id_pinjam=<?=$id_pinjam?>">
                                                                <button type="button" class="checked btn btn-warning">Check</button>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                <?php
